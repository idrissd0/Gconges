  ...
  <div id="form-outer">
    ...
    <form id="survey-form" method="POST">
      ...
      <div class="rowTab">
        ...
        <div class="rightTab">
          <input type="text" name="prenomA" id="prenom" class="input-field"   >
        </div>
      </div>
      ...
      <div class="rowTab">
        <div class="labels">
          <label id="number-label" for="DateR">*Date de Recrutement :</label>
        </div>
        <div class="rightTab">
          <input type="date" name="DateR" id="DateR"  class="input-field"   required>
        </div>
      </div>
      <!-- choix du service-->
      <div class="rowTab">
        ...
        <div class="rightTab">
         ...
         <div class="rowTab">
          <div class="labels">
            <label id="number-label" for="DateA">*Date de affectation :</label>
          </div>
          <div class="rightTab">
            <input type="date" name="DateA" id="DateA"  class="input-field"   required>
          </div>
        </div>
             <!-- choix du Fonction -->
      <div class="rowTab">
...
<?php /**PATH C:\Users\Lenovo\GCformulaire\resources\views/welcome.blade.php ENDPATH**/ ?>