...
<html>
  ...
  <div id="form-outer">
    ...
    <form id="survey-form" method="POST" action="add">
      @csrf
...
{{-- <div class="rowTab">
<div class="labels">
    <label id="number-label" for="DateNaiss">*Date de Naissance :</label>
</div>
<div class="rightTab">
    <input type="date" name="DateNaiss" id="DateR"  class="input-field"   required>
</div>
</div> --}}
      <!-- choix du service-->
      <div class="rowTab">
    ...
    <div class="rowTab">
      ...
      <div class="rowTab">
       ...
       <div class="rowTab">
        ...
        <div class="rightTab">
            {{-- <strong><ul id="preferences">
                <li class="radio"><label><input name="EtatMatmoniale" value="Marié(e)" type="radio">Marié(e)</label>
                </li>
                <li class="radio"><label><input name="EtatMatmoniale" value="Dévorcé" type="radio">Dévorcé</label>
                </li>
                <li class="radio"><label><input name="EtatMatmoniale" value="Inconnu" type="radio" >Inconnu</label>
                </li>
                <li class="radio"><label><input name="EtatMatmoniale" value="Célibataire" type="radio">Célibataire</label>
                </li>
      ...
      <div class="rowTab">
        ...
        <div class="rightTab">
          {{-- <input autofocus type="textarea" name="Obs" id="Obs" class="input-field"> --}}
      ...
      <div class="rowTab">
        ...
        <div class="rightTab">
          <input type="date" name="DateDC" id="Date" class="input-field"  >
        </div>
      </div>
       <!--Date fin du conges-->
       <div class="rowTab">
        ...
        <div class="rightTab">
          <input type="date" name="DateFC" id="Date" class="input-field"  >
        </div>
      </div>
       <!--Date debut du conges-->
       <div class="rowTab">
        ...
        <div class="rightTab">
          <input type="date" name="DateR" id="Date" class="input-field"  >
        </div>
      </div>
       ...
       <div class="rowTab">
        ...
        <div class="rightTab">
          <input type="number" name="NbrC" id="Date" class="input-field"    >
        </div>
      </div>
       <!--Type de Congé-->
       <div class="rowTab">
        ...
        <div class="rightTab">
          <select id="dropdown" name="TConges" class="dropdown" >
       ...
       <div class="rowTab">
        ...
        <div class="rightTab">
          <input  type="text" name="Adrs" id="Adrs" class="input-field" >
        </div>
      </div>
          <!--Observation-->
          <div class="rowTab">
            ...
            <div class="rightTab">
              <input autofocus type="text" name="Obse" id="Obs" class="input-field"  >
            </div>
          </div>
      </fieldset></strong>
